...
if ($_SERVER['REQUEST_METHOD']==='POST') {
    ...
    $pw = $_POST['password'];
    $q = mysqli_query($conn,"SELECT * FROM users WHERE email='$email' AND role='kader' LIMIT 1");
    ...
    } else $err='Akun kader tidak ditemukan.';
}
?>
<!doctype html><html lang="id"><head><meta charset="utf-8"><title>Login Kader</title>
<link href="/assets/css/style.css" rel="stylesheet">
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"></head>
<body>
<div class="container py-5"><div class="row justify-content-center"><div class="col-md-5">
  <div class="card p-4"><h4>Login Kader</h4>
